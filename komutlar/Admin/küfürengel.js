...
.setDescription(`The Profanity Filter is not already set!`)]})
    ...
    if (!message.member.permissions.has(PermissionsBitField.Flags.Administrator)) return message.reply({content: `Bu Komutu Kullanabilmeniz İçin **ADMİN** Yetkisine Sahip Olmanız Gerekmektedir.`})
       if (!args[0]) return message.channel.send({embeds:[
            new EmbedBuilder()
              .setColor("#ff0000")
              .setTimestamp()
              .setDescription(`<a:ghost_dia:1156703800363581462> **Küfür Filtresini Ayarlamak İçin** \`w!küfür-engel aç\` | **Kapatmak İstiyorsanız** \`w!küfür-engel kapat\` Yazabilirsiniz`)]})     
  ...
  if(args[0] === 'aç') {
    ...
    message.channel.send({embeds:[
              ...
              .setColor("#ff0000")
              .setTimestamp()
              .setDescription('<a:ghost_yes:1156683590881521705> **Küfür filtresi Başarılı Şekilde Aktif Edildi.**')]})
  ...
  message.channel.send({embeds:[
              ...
              .setColor("#ff0000")
              .setTimestamp()
              .setDescription(`<a:ghost_yes:1156683590881521705> **Küfür Filtresini başarıyla Kapattım.**`)]})
} else return message.channel.send({embeds:[
  new EmbedBuilder()
  .setColor("#ff0000")
  .setTimestamp()
