...
.setColor(`#000001`)
.setDescription(`
w!sayaç log : sayaç logunu ayarlarsınız.
w!sayaç hedef : sayaç hedefini belirlersiniz.
w!sayaç sıfırla : sayaç sistemini kapatırsınız.
`)
...
message.reply(`<a:ghost_yes:1156683590881521705> Başarılı bir şekilde sayaç log ${kanal} olarak belirlendi.`)
}
...
message.reply(`<a:ghost_yes:1156683590881521705> Sayaç hedefi **${hedef}** olarak ayarlandı.`)
}
...
message.reply(`<a:ghost_yes:1156683590881521705> Sayaç ayarlamaları sıfırlanmıştır.`)
}
