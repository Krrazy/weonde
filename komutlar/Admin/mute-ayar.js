...
message.reply(`<a:ghost_yes:1156683590881521705> Mute atıldığında kişinin tüm rollerini alıp ${rol} isimli rolü vericeğim.`)
...
if(args[0] == "mute-yetkilisi"){
    ...
    message.reply(`<a:ghost_yes:1156683590881521705> Sadece ${rol} isimli rolü olan kişiler mute atabilecek.`)
    ...
    if(args[0] == "log"){
        ...
        message.reply(`<a:ghost_yes:1156683590881521705> Mute atıldığında artık ${kanal} isimli kanalda log tutucam`)
