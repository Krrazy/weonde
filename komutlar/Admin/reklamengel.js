...
new EmbedBuilder()
        .setColor("#ff0000")
        .setTimestamp()
        .setDescription(`<a:ghost_dia:1156703800363581462> Reklam Filtresini Ayarlamak İçin \`w!reklam-engel aç\` | Kapatmak İstiyorsanız \`w!reklam-engel kapat\` Yazabilirsiniz`)]})     
...
new EmbedBuilder()
        .setColor("#ff0000")
        .setTimestamp()
        .setDescription('<a:ghost_yes:1156683590881521705> Reklam Filtresi başarıyla açıldı.')]})
...
message.channel.send({embeds:[
        ...
        .setColor("#ff0000")
        .setTimestamp()
        .setDescription(`<a:ghost_yes:1156683590881521705> Link-Engel sistemini başarıyla Kapattım.`)]})
} else return message.channel.send({embeds:[
new EmbedBuilder()
.setColor("#ff0000")
.setTimestamp()
