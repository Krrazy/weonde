        ...
        const row = new ActionRowBuilder()
            .addComponents(
                new ButtonBuilder()
                    ...
                    .setURL(`https://discord.com/api/oauth2/authorize?client_id=1162495723091271801&permissions=8&scope=bot%20applications.commands`)
                    .setEmoji("🔗")
            ...
            .addComponents(
                new ButtonBuilder()
                    .setLabel("Oy")
                    .setURL(`https://top.gg/bot/1162495723091271801/vote`)
                    .setEmoji("🔗")
                    .setStyle(ButtonStyle.Link)
            )
            .addComponents(
                new ButtonBuilder()
                    ...
                    .setURL(`https://discord.gg/nitrobase`)
                    .setEmoji("🔗")
                    .setStyle(ButtonStyle.Link)
            )
